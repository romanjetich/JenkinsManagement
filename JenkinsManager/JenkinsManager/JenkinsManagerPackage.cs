...
namespace JenkinsManager
{
    ...
    {
        /// <summary>
        /// JenkinsManagerPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "e3682a78-008c-459f-abc4-72e17e759e34";
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            await JenkinsWindowCommand.InitializeAsync(this);
        }
